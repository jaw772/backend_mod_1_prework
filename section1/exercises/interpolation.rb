...
# Remember, the goal is to be concise but descriptive (it's a hard balance!) Then, log out ONE sentence that
# incorporates all THREE variables.
fur = "fluffy"
animal = "dog"
enemy = "cat"

p "The short-haired #{enemy} could not evade the #{fur} #{animal}!"
